...
ВЕРСИЯ 5.10: МИНИМАЛЬНАЯ ИНТЕГРАЦИЯ 4F МОДУЛЯ
"""
...
from constants import (
    ...
    # 👇 ДОБАВЛЯЕМ ТОЛЬКО САМЫЕ НЕОБХОДИМЫЕ СОСТОЯНИЯ
...
# ===== ИМПОРТ 18+ МОДУЛЯ (С НЕОБХОДИМЫМИ ФУНКЦИЯМИ) =====
from sexual_18_plus import (
    ...
    split_long_message,
    safe_send_message,
    # 👇 ДОБАВЛЯЕМ ТОЛЬКО НУЖНЫЕ ФУНКЦИИ
...
def main():
    ...
    print("\n" + "="*70)
    print("🧠 ВИРТУАЛЬНЫЙ ПСИХОЛОГ ВАРИАТИКА (ВЕРСИЯ 5.10)")
    print("="*70)
    ...
    logger.info("✅ ВЕРСИЯ 5.10: МИНИМАЛЬНАЯ ИНТЕГРАЦИЯ 4F!")
    logger.info("✅ Константы вынесены в отдельный файл constants.py")
    logger.info("✅ Добавлены только необходимые состояния для 4F")
