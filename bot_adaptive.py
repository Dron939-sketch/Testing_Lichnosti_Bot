...
STAGE_1_QUESTIONS = [
    ...
    },
    {
        ...
        "options": {
            "a": {"text": "Кругосветное путешествие с группом", "scores": {"EXTERNAL": 2}},
...
# ============================================
# ЭТАП 3: ПОВЕДЕНЧЕСКИЕ ПАТТЕРНЫ (ОБНОВЛЕН ПО ТЗ)
# ============================================
...
# ============================================
# ЭТАП 4: КОНФЛИКТ ЛОГИЧЕСКИХ УРОВНЕЙ (ОБНОВЛЕН ПО ТЗ)
# ============================================
...
# ============================================
# УТОЧНЯЮЩИЕ ВОПРОСЫ (ОБНОВЛЕННЫЕ ИЗ ТЗ для ЭТАПА 3 и 4)
# ============================================
...
CLARIFICATION_QUESTIONS = {
    "stage1_external_internal": [
        ...
        },
        {
            ...
            "options": {
                "a": {"text": "Люди и событий вокруг", "scores": {"EXTERNAL": 2}},
    ...
    "stage3_discrepancy": [
        {
            "id": "c3_1",
            "text": "🔍 УТОЧНЯЮЩИЙ ВОПРОС\n\nКак часто действуете на автомате?",
            "options": {
    ...
    "stage4_tie": [
        {
            "id": "c4_1",
            "text": "🔍 УТОЧНЯЮЩИЙ ВОПРОС\n\nЧто чаще становится причиной застоя?",
            "options": {
        ...
        {
            "id": "c4_2",
            "text": "🔍 УТОЧНЯЮЩИЙ ВОПРОС\n\nЧто приносит больше дискомфорта?",
            "options": {
...
# ============================================
# ПСИХОЛОГИЧЕСКИЕ ПОДСКАЗКИ (ОБНОВЛЕННЫЕ ИЗ ТЗ для ЭТАПОВ 3 и 4)
# ============================================
...
# ============================================
# ЭКРАНЫ ПЛАТЕЖНОЙ СИСТЕМЫ (ОБНОВЛЕНА СТОИМОСТЬ НА 690 РУБЛЕЙ)
# ============================================
...
async def show_payment_screen(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Создаем платеж через API с суммой 690 рублей
...
# ============================================
# ЭТАП 3: ПОВЕДЕНЧЕСКИЕ ПАТТЕРНЫ (ОБНОВЛЕННЫЕ ЭКРАНЫ ИЗ ТЗ)
# ============================================
...
async def show_stage_3_details(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    details_text = (
        f"🧠 <b>ЭВОЛЮЦИЯ ПОВЕДЕНЧЕСКИХ РЕАКЦИЙ</b>\n\n"
...
async def finish_stage_3(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    result_text = (
        ...
        f"🧠 Эволюция поведенческих реакций проанализирована\n\n"
        f"<i>Отлично! Теперь я вижу уровень развития ваших поведенческих паттернов.</i>\n\n"
...
# ============================================
# ЭТАП 4: КОНФЛИКТ ЛОГИЧЕСКИХ УРОВНЕЙ (ОБНОВЛЕННЫЕ ЭКРАНЫ ИЗ ТЗ)
# ============================================
