...
STAGE_2_QUESTIONS = {
    "СОЦИАЛЬНО-АФФИЛИАТИВНЫЙ": [
        {"id": "q2_1", "text": "Сколько у тебя близких людей?\n\n(С кем можно говорить о личном)", "options": {"a": {"text": "Нет таких", "level": 1}, "b": {"text": "1-2 человека", "level": 2}, "c": {"text": "3-5 человек", "level": 3}, "d": {"text": "Больше 5", "level": 5}}},
        {"id": "q2_2", "text": "Как ты к этому относишься?", "options": {"a": {"text": "Мне не хватает близости", "level": 1}, "b": {"text": "Я в процессе поиска своих людей", "level": 2}, "c": {"text": "Меня это устраивает", "level": 3}, "d": {"text": "Я не нуждаюсь в этом", "level": 4}}},
        {"id": "q2_3", "text": "Как часто за месяц ты отменяешь встречи с друзьями?", "options": {"a": {"text": "Не отменяю / нет встреч", "level": 1}, "b": {"text": "1-2 раза", "level": 3}, "c": {"text": "3-5 раз", "level": 2}, "d": {"text": "Постоянно отменяю", "level": 1}}},
        {"id": "q2_4", "text": "Почему отменяешь?", "options": {"a": {"text": "Нет сил на людей", "level": 1}, "b": {"text": "Эти люди не мои", "level": 2}, "c": {"text": "Появились более важные дела", "level": 5}, "d": {"text": "Не отменяю", "level": 3}}},
        {"id": "q2_5", "text": "Как часто ты чувствуешь, что тебя не понимают?", "options": {"a": {"text": "Постоянно", "level": 1}, "b": {"text": "Часто", "level": 2}, "c": {"text": "Иногда", "level": 4}, "d": {"text": "Редко или никогда", "level": 3}}},
        {"id": "q2_6", "text": "Что ты с этим делаешь?", "options": {"a": {"text": "Пытаюсь объясниться", "level": 1}, "b": {"text": "Ищу тех, кто поймёт", "level": 2}, "c": {"text": "Принимаю это", "level": 4}, "d": {"text": "Меня понимают", "level": 3}}},
        {"id": "q2_7", "text": "Твой друг постоянно меняет компании.\n\nКак думаешь, почему?", "options": {"a": {"text": "Ищет своих людей", "level": 2}, "b": {"text": "Боится близости", "level": 1}, "c": {"text": "Ему везде интересно", "level": 5}, "d": {"text": "Не может быть собой", "level": 4}}},
        {"id": "q2_8", "text": "Что для тебя значит «найти своих людей»?", "options": {"a": {"text": "Место, где меня принимают", "level": 2}, "b": {"text": "Люди, с которыми не нужно притворяться", "level": 3}, "c": {"text": "Глубокая связь на уровне ценностей", "level": 5}, "d": {"text": "Не думал об этом", "level": 1}}}
    ],
    "ЭКЗИСТЕНЦИАЛЬНО-РЕФЛЕКСИВНЫЙ": [
        {"id": "q2_1", "text": "Как часто ты задаёшь себе вопрос «В чём смысл?»", "options": {"a": {"text": "Постоянно, это мучительно", "level": 1}, "b": {"text": "Часто, ищу ответы", "level": 2}, "c": {"text": "Иногда, это интересно", "level": 4}, "d": {"text": "Редко, я знаю свой смысл", "level": 5}}},
        {"id": "q2_2", "text": "Что ты чувствуешь, когда остаёшься наедине с собой?", "options": {"a": {"text": "Тревогу, пустоту", "level": 1}, "b": {"text": "Вопросы без ответов", "level": 2}, "c": {"text": "Спокойствие, ясность", "level": 4}, "d": {"text": "Глубину, полноту", "level": 5}}},
        {"id": "q2_3", "text": "Сколько времени в день ты проводишь в размышлениях?", "options": {"a": {"text": "Почти всё время (застреваю)", "level": 1}, "b": {"text": "Несколько часов", "level": 2}, "c": {"text": "1-2 часа осознанно", "level": 4}, "d": {"text": "Мало, я живу в моменте", "level": 5}}},
        {"id": "q2_4", "text": "Что происходит после размышлений?", "options": {"a": {"text": "Ещё больше вопросов", "level": 1}, "b": {"text": "Новые идеи, но нет действий", "level": 2}, "c": {"text": "Понимание и действия", "level": 4}, "d": {"text": "Трансформация опыта", "level": 5}}},
        {"id": "q2_5", "text": "Как ты относишься к своим переживаниям?", "options": {"a": {"text": "Боюсь их, избегаю", "level": 1}, "b": {"text": "Анализирую, пытаюсь понять", "level": 2}, "c": {"text": "Принимаю и наблюдаю", "level": 4}, "d": {"text": "Использую как материал для роста", "level": 5}}},
        {"id": "q2_6", "text": "Что для тебя значит «быть собой»?", "options": {"a": {"text": "Не знаю, кто я", "level": 1}, "b": {"text": "Ищу себя", "level": 2}, "c": {"text": "Знаю и принимаю себя", "level": 4}, "d": {"text": "Я — это процесс, а не статус", "level": 5}}},
        {"id": "q2_7", "text": "Человек погружён в экзистенциальный кризис.\n\nЧто ему делать?", "options": {"a": {"text": "Отвлечься, не думать об этом", "level": 1}, "b": {"text": "Искать ответы (книги, терапия)", "level": 2}, "c": {"text": "Прожить это как опыт", "level": 4}, "d": {"text": "Это не кризис, а трансформация", "level": 5}}},
        {"id": "q2_8", "text": "Что для тебя глубина жизни?", "options": {"a": {"text": "Не понимаю, что это", "level": 1}, "b": {"text": "Хочу её найти", "level": 2}, "c": {"text": "Чувствую её в моменты", "level": 4}, "d": {"text": "Живу в ней постоянно", "level": 5}}}
    ],
    "ИНСТРУМЕНТАЛЬНО-ДОСТИЖЕНЧЕСКИЙ": [
        {"id": "q2_1", "text": "Сколько целей ты достиг за последний год?", "options": {"a": {"text": "Ни одной (только планировал)", "level": 1}, "b": {"text": "1-2 цели", "level": 2}, "c": {"text": "3-5 целей", "level": 4}, "d": {"text": "Больше 5 целей", "level": 5}}},
        {"id": "q2_2", "text": "Как ты себя чувствуешь, когда достигаешь цели?", "options": {"a": {"text": "Пусто (а что дальше?)", "level": 1}, "b": {"text": "Радость, но ненадолго", "level": 2}, "c": {"text": "Удовлетворение", "level": 4}, "d": {"text": "Уже думаю о следующей", "level": 5}}},
        {"id": "q2_3", "text": "Как часто ты откладываешь важные дела?", "options": {"a": {"text": "Постоянно (прокрастинация)", "level": 1}, "b": {"text": "Часто", "level": 2}, "c": {"text": "Иногда", "level": 4}, "d": {"text": "Редко или никогда", "level": 5}}},
        {"id": "q2_4", "text": "Почему откладываешь?", "options": {"a": {"text": "Страх неудачи", "level": 1}, "b": {"text": "Не знаю, с чего начать", "level": 2}, "c": {"text": "Жду подходящего момента", "level": 4}, "d": {"text": "Не откладываю", "level": 5}}},
        {"id": "q2_5", "text": "Что для тебя успех?", "options": {"a": {"text": "Не знаю, не достигал", "level": 1}, "b": {"text": "Деньги, статус, признание", "level": 2}, "c": {"text": "Реализация своих целей", "level": 4}, "d": {"text": "Влияние и вклад в мир", "level": 5}}},
        {"id": "q2_6", "text": "Как ты относишься к конкуренции?", "options": {"a": {"text": "Избегаю её", "level": 1}, "b": {"text": "Боюсь проиграть", "level": 2}, "c": {"text": "Мотивирует меня", "level": 4}, "d": {"text": "Играю свою игру", "level": 5}}},
        {"id": "q2_7", "text": "Человек хочет большего, но не действует.\n\nПочему?", "options": {"a": {"text": "Не верит в себя", "level": 1}, "b": {"text": "Не знает, как", "level": 2}, "c": {"text": "Ждёт готовности", "level": 4}, "d": {"text": "На самом деле не хочет", "level": 5}}},
        {"id": "q2_8", "text": "Что важнее: процесс или результат?", "options": {"a": {"text": "Результат, но его нет", "level": 1}, "b": {"text": "Результат любой ценой", "level": 2}, "c": {"text": "Баланс процесса и результата", "level": 4}, "d": {"text": "Процесс = результат", "level": 5}}}
    ],
    "СТРУКТУРНО-АНАЛИТИЧЕСКИЙ": [
        {"id": "q2_1", "text": "Насколько упорядочена твоя жизнь?", "options": {"a": {"text": "Хаос, не могу навести порядок", "level": 1}, "b": {"text": "Пытаюсь структурировать", "level": 2}, "c": {"text": "Есть система, которая работает", "level": 4}, "d": {"text": "Гибкая структура под задачи", "level": 5}}},
        {"id": "q2_2", "text": "Что происходит, когда нарушается твой порядок?", "options": {"a": {"text": "Паника, тревога", "level": 1}, "b": {"text": "Раздражение, дискомфорт", "level": 2}, "c": {"text": "Адаптируюсь", "level": 4}, "d": {"text": "Это часть процесса", "level": 5}}},
        {"id": "q2_3", "text": "Как ты принимаешь решения?", "options": {"a": {"text": "Не могу выбрать (анализ-паралич)", "level": 1}, "b": {"text": "Долго взвешиваю все варианты", "level": 2}, "c": {"text": "Анализирую и выбираю оптимальное", "level": 4}, "d": {"text": "Быстро, на основе критериев", "level": 5}}},
        {"id": "q2_4", "text": "Что для тебя понимание?", "options": {"a": {"text": "Не могу понять, как всё устроено", "level": 1}, "b": {"text": "Ищу логику и закономерности", "level": 2}, "c": {"text": "Вижу систему и связи", "level": 4}, "d": {"text": "Создаю новые модели понимания", "level": 5}}},
        {"id": "q2_5", "text": "Как ты относишься к неопределённости?", "options": {"a": {"text": "Не выношу её", "level": 1}, "b": {"text": "Пытаюсь всё просчитать", "level": 2}, "c": {"text": "Принимаю как данность", "level": 4}, "d": {"text": "Использую как ресурс", "level": 5}}},
        {"id": "q2_6", "text": "Сколько у тебя систем организации жизни?", "options": {"a": {"text": "Нет системы", "level": 1}, "b": {"text": "Пробую разные, ничего не работает", "level": 2}, "c": {"text": "Одна рабочая система", "level": 4}, "d": {"text": "Несколько интегрированных систем", "level": 5}}},
        {"id": "q2_7", "text": "Человек перегружен информацией.\n\nЧто делать?", "options": {"a": {"text": "Избегать информации", "level": 1}, "b": {"text": "Пытаться всё изучить", "level": 2}, "c": {"text": "Фильтровать по критериям", "level": 4}, "d": {"text": "Создать систему обработки", "level": 5}}},
        {"id": "q2_8", "text": "Что для тебя контроль?", "options": {"a": {"text": "Не могу контролировать жизнь", "level": 1}, "b": {"text": "Пытаюсь всё контролировать", "level": 2}, "c": {"text": "Контролирую важное", "level": 4}, "d": {"text": "Контроль = осознанность", "level": 5}}}
    ]
}
...
CLARIFICATION_QUESTIONS = {
    ...
    "stage2_borderline": [
        {"id": "c2_1", "text": "🔍 УТОЧНЯЮЩИЙ ВОПРОС\n\nКак часто ты чувствуешь, что застрял на месте?", "options": {"a": {"text": "Постоянно, не знаю как двигаться", "level": 2}, "b": {"text": "Иногда, но нахожу выход", "level": 4}, "c": {"text": "Редко, я в движении", "level": 5}}},
        {"id": "c2_2", "text": "🔍 УТОЧНЯЮЩИЙ ВОПРОС\n\nКак ты относишься к своим прошлым ошибкам?", "options": {"a": {"text": "Стыжусь их, избегаю вспоминать", "level": 2}, "b": {"text": "Анализирую и учусь", "level": 4}, "c": {"text": "Принимаю как опыт", "level": 5}}}
    ],
    "stage3_discrepancy": [
        {"id": "c3_1", "text": "🔍 УТОЧНЯЮЩИЙ ВОПРОС\n\nВспомни последний месяц. Сколько раз ты действовал не так, как хотел?", "options": {"a": {"text": "Постоянно", "level": 1}, "b": {"text": "Часто (больше 5 раз)", "level": 2}, "c": {"text": "Иногда (2-4 раза)", "level": 3}, "d": {"text": "Редко (0-1 раз)", "level": 5}}},
        {"id": "c3_2", "text": "🔍 УТОЧНЯЮЩИЙ ВОПРОС\n\nКак быстро ты замечаешь свои автоматические реакции?", "options": {"a": {"text": "Не замечаю, действую на автомате", "level": 1}, "b": {"text": "Замечаю после", "level": 2}, "c": {"text": "Замечаю в процессе", "level": 4}, "d": {"text": "Замечаю до и могу изменить", "level": 5}}},
        {"id": "c3_3", "text": "🔍 УТОЧНЯЮЩИЙ ВОПРОС\n\nКак часто ты делаешь то, что обещал себе?", "options": {"a": {"text": "Почти никогда", "level": 1}, "b": {"text": "Иногда", "level": 2}, "c": {"text": "Часто", "level": 4}, "d": {"text": "Почти всегда", "level": 5}}}
    ],
    "stage4_tie": [
...
async def show_stage_4_details(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    details_text = (
        f"<b>📖 ЧТО ТАКОЕ КОНФИГУРАЦИЯ ЛОГИЧЕСКИХ УРОВНЕЙ?</b>\n\n"
