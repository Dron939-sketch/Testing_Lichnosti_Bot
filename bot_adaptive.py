...
# ЭТАП 2: КОНФИГУРАЦИЯ МЫШЛЕНИЯ (примеры для социально-аффилиативного типа)
STAGE_2_QUESTIONS = {
    ...
    # Добавь аналогичные вопросы для остальных типов
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        ...
        f"2️⃣ <b>ЭТАП 2:</b> Конфигурация мышления (8-12 вопросов)\n"
...
async def show_result(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    result_text = (
        ...
        f"[Здесь будет модульное описание на основе типа + уровня + проблемы]\n\n"
        f"<b>🚀 ВЕКТОР РАЗВИТИЯ:</b>\n\n"
        f"[Здесь будут персональные рекомендации]\n\n"
