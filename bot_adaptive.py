...
4 этапа адаптивного исследования + 18+ модуль
ВЕРСИЯ 6.0: ПОЛНАЯ ИНТЕГРАЦИЯ ТЕСТА И 18+ МОДУЛЯ
"""
...
from constants import (
    ...
    BUY_PACKAGES, INVITES_LIST_LEGACY, FRIEND_MENU
)
...
def main():
    ...
    print("="*70)
    print("🔞 ПОЛНАЯ ИНТЕГРАЦИЯ ТЕСТА И 18+ МОДУЛЯ")
    print("="*70)
