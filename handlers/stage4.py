...
async def show_stage_4_intro(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    f"👁️ Восприятие — что вы видите.\n"
    f"🧠 Мышление — как понимаете.\n"
    f"🔄 Поведение — как реагируете.\n"
    f"🏠 <b>Всё это — ваша внутренняя система.</b>\n"
    f"🌍 Но она живёт внутри внешней системы — общества, которое постоянно меняется.\n"
    f"⚡ <b>Когда одна система меняется, а другая — нет, возникает напряжение.</b>\n"
    f"🔍 Здесь мы найдём, где именно могут возникать потенциальные точки напряжения между вашей системой и системой, в которой вы находитесь.\n\n"
    f"📊 <b>Вопросов:</b> 8\n"
