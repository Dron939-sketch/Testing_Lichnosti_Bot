...
▸ Как работает конфигурация восприятия
...
CONFLICT_PHRASES = {
    ...
    "VALUES": {
        "note": "🔥 <b>ПРИМЕЧАНИЕ:</b>\nВнутри вас конфликт:\nВЫ одновременно хотите противоречивых вещей. Одна часть тянет в одну сторону, другая — в противоположную. Из-за этого вы топчетесь на месте и не можете двинуться ни туда, ни сюда.",
